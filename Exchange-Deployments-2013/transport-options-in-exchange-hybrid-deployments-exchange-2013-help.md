---
title: 'Transport options in Exchange hybrid deployments: Exchange 2013 Help'
TOCTitle: Transport options in Exchange hybrid deployments
ms:assetid: da605a78-5429-4de8-8b04-bc4c45a41ba1
ms:mtpsurl: https://technet.microsoft.com/en-us/library/JJ659055(v=EXCHG.150)
ms:contentKeyID: 49345020
ms.date: 02/05/2016
...
You’ll need to choose how to route inbound and outbound mail when you plan and configure your hybrid deployment. The route taken by inbound and outbound messages sent to and from recipients in the on-premises and Exchange Online organizations depends on the following:
  ...
  - Do you want to deploy an Edge Transport server in your on-premises organization?
    ...
    If you don’t want to expose your domain-joined internal Exchange servers directly to the Internet, you can deploy Edge Transport servers in your perimeter network. For more information about adding an Edge Transport server to your hybrid deployment, see [Edge Transport servers with hybrid deployments](edge-transport-servers-with-hybrid-deployments-exchange-2013-help.md).
...
To learn more about how these options affect message routing in your organization, see [Transport routing in Exchange hybrid deployments](transport-routing-in-exchange-hybrid-deployments-exchange-2013-help.md).
