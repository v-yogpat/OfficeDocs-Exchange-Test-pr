...
Before you start working with this checklist, make sure you're familiar with the concepts in:
  ...
  - [Telephone system integration with UM](telephone-system-integration-with-um-exchange-2013-help.md)
...
<td><p><a href="create-a-um-dial-plan-exchange-2013-help.md">Create a UM dial plan</a></p>
...
<td><p><a href="create-a-um-ip-gateway-exchange-2013-help.md">Create a UM IP gateway</a></p>
...
<td><p><a href="create-a-um-auto-attendant-exchange-2013-help.md">Create a UM auto attendant</a></p>
...
<p><a href="manage-voice-mail-settings-for-a-user-exchange-2013-help.md">Manage voice mail settings for a user</a></p></td>
</tr>
<tr class="even">
<td><p> </p></td>
...
<td><p><a href="configuration-notes-for-supported-voip-gateways-ip-pbxs-and-pbxs-exchange-2013-help.md">Configuration notes for supported VoIP gateways, IP PBXs, and PBXs</a> <a href="connect-a-voip-gateway-ip-pbx-or-session-border-controller-to-um-exchange-2013-help.md">Connect a VoIP gateway, IP PBX, or session border controller to UM</a></p></td>
</tr>
<tr class="odd">
<td><p></p></td>
