...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Bb123819(v=EXCHG.150)
ms:contentKeyID: 49315466
ms.date: 12/10/2017
...
1.  
    ...
    In the EAC, navigate to **Unified Messaging** \> **UM dial plans**, and then click **New** ![Add Icon](images/JJ218640.c1e75329-d6d7-4073-a27d-498590bbb558(EXCHG.150).gif "Add Icon").
