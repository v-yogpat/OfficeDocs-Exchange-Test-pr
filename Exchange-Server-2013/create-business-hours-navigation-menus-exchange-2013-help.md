...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Bb232203(v=EXCHG.150)
ms:contentKeyID: 49315550
ms.date: 12/10/2017
...
2.  On the **UM Dial Plan** page, under **UM Auto Attendants**, select the UM auto attendant for which you want to create a business hours navigation menu. On the toolbar, click **Edit** ![Edit icon](images/JJ218640.6f53ccb2-1f13-4c02-bea0-30690e6ea71d(EXCHG.150).gif "Edit icon").

3.  On the **UM Auto Attendant** page, click **Menu navigation**, under **Business hours menu navigation**, select **Enable business hours menu navigation**, and then click **Add** ![Add Icon](images/JJ218640.c1e75329-d6d7-4073-a27d-498590bbb558(EXCHG.150).gif "Add Icon").
