...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Ee633465(v=EXCHG.150)
ms:contentKeyID: 49315411
ms.date: 12/10/2017
...
For detailed instructions, see [Create a UM dial plan](create-a-um-dial-plan-exchange-2013-help.md).

## Step 2: Disable the user for Unified Messaging

For detailed instructions, see [Disable voice mail for a user](disable-voice-mail-for-a-user-exchange-2013-help.md).
