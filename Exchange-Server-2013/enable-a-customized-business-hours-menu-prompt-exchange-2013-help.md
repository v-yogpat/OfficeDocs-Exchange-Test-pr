...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Bb232116(v=EXCHG.150)
ms:contentKeyID: 50067628
ms.date: 12/10/2017
...
> [!IMPORTANT]
> You must configure business hours on the auto attendant. For details, see <A href="configure-business-hours-exchange-2013-help.md">Configure business hours</A>.
...
2.  On the **UM Dial Plan** page, under **UM Auto Attendants**, select the UM auto attendant for which you want to enable a customized business hours menu prompt, and then click **Edit** ![Edit icon](images/JJ218640.6f53ccb2-1f13-4c02-bea0-30690e6ea71d(EXCHG.150).gif "Edit icon").
