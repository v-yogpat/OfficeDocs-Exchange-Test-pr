...
ms:mtpsurl: https://technet.microsoft.com/en-us/library/Ee423540(v=EXCHG.150)
ms:contentKeyID: 49315366
ms.date: 12/10/2017
...
2.  On the **UM Dial Plan** page, under **UM Auto Attendants**, select the UM auto attendant for which you want to set the business location, and then click **Edit** ![Edit icon](images/JJ218640.6f53ccb2-1f13-4c02-bea0-30690e6ea71d(EXCHG.150).gif "Edit icon").
